...
test_data_path = "./GaE_Dataset_final/Testing/Grayscale/New_folder"
test_label_path = "./GaE_Dataset_final/Testing/Masks/New_folder"

# Path to save generated .npz files
npz_saving_path = "./GaE_final_Gray/test_npz/"
