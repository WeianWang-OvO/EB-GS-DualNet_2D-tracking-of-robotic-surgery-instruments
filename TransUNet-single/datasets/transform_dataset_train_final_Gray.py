...
train_data_path = "./GaE_Dataset_final/Training/Grayscale/New_folder"
train_label_path = "./GaE_Dataset_final/Training/Masks/New_folder"

# Path to save generated .npz files
npz_saving_path = "./GaE_final_Gray/train_npz/"
